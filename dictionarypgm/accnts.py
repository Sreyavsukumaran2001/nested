...
#2 PRINT SAVINGS TYPES ACCOUNT DETAILS

savings_type=[ ac["acno"] for ac in accounts if ac["ac_type"]=="savings"]
print(savings_type)


#3 SORT ACCOUNTS BASED ON BALANCE ORDER  BY DESCENDING

accounts.sort(reverse=True,key=lambda ac:ac["balance"])
print(accounts)

#4 PRINT ALL PHONE PAY TRANSCATIONS
#5 PRINT ALL TRANSCATIONS WHRER TRANSCATIONS AMOUNT>500
#6 CREDIT TRANSCATIONS OF1002
#7 AGGREGATE TRANSCATIONS BASED ON PAYEMENT MODE